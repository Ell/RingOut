...
#
# Usage:
#   publish-tag-draft-assets.sh --create-release --tag v1.2.1-ell.7 FILE FILE.sha256 [...]
#   publish-tag-draft-assets.sh --join-release --tag v1.2.1-ell.7 FILE FILE.sha256 [...]
#
