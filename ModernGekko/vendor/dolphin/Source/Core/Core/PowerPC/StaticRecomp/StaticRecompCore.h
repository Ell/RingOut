...
private:
  ...
  u64 m_sc2_engine_replay_original_endpoint_tb_remainder = 0;
  ...
  std::size_t m_sc2_engine_replay_corrected_state_bytes = 0;
  ...
  std::unordered_map<u32, u32> m_sc2_update_original_last_writer;
