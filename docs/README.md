...
| [SC2 game-specific rollback](sc2-slippi-rollback.md) | Slippi/GGPO comparison, exact game-hook discovery, engine-tick/SI replay oracle, selective checkpoint groundwork, and certification gates |
